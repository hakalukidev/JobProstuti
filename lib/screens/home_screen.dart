            ...
            child: ListView(
              ...
              children: [
                _buildDrawerItem(
                  'হোম',
                  Icons.home_rounded,
                  () => _scrollToSection(_heroOffset),
                ),
                _buildDrawerItem(
                  'ফিচার',
                  Icons.featured_play_list_rounded,
                  () => _scrollToSection(_featuresOffset),
                ),
                _buildDrawerItem(
                  'কোর্স',
                  Icons.school_rounded,
                  () => _scrollToSection(_coursesOffset),
                ),
                _buildDrawerItem(
                  'গাইডলাইন',
                  Icons.auto_stories_rounded,
                  () => _scrollToSection(_guidelineOffset),
                ),
                _buildDrawerItem(
                  'প্যাকেজ প্ল্যান',
                  Icons.payments_rounded,
                  () => _scrollToSection(_pricingOffset),
                ),
                _buildDrawerItem(
                  'ডাউনলোড অ্যাপ',
                  Icons.download_rounded,
                  () => _scrollToSection(_ctaOffset),
                ),
              ...
              title: Row(
                children: [
                  ...
                  if (!isMobile) ...[
                    ...
                    _NavLink(
                      'ফিচার',
                      onTap: () => _scrollToSection(_featuresOffset),
                    ),
                    const SizedBox(width: 24),
                    _NavLink(
                      'কোর্স',
                      onTap: () => _scrollToSection(_coursesOffset),
                    ),
                    const SizedBox(width: 24),
                    _NavLink(
                      'গাইডলাইন',
                      onTap: () => _scrollToSection(_guidelineOffset),
                    ),
                    const SizedBox(width: 24),
                    _NavLink(
                      'প্যাকেজ প্ল্যান',
                      onTap: () => _scrollToSection(_pricingOffset),
                    ),
                    const SizedBox(width: 24),
                    _NavLink(
                      'ডাউনলোড অ্যাপ',
                      onTap: () => _scrollToSection(_ctaOffset),
                    ),
                    const SizedBox(width: 32),
                  ],
            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                padding: EdgeInsets.symmetric(
                  horizontal: isMobile
                      ? 24
                      : (Responsive.isTablet(context) ? 60 : 170),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: const [PlayStoreButton(), CallButton()],
                          ),
                          const SizedBox(height: 48),
                          Row(
                              ...
                              SizedBox(
                                ...
                                child: Stack(
                                  children: [
                                    Positioned(
                                      left: 0,
                                      child: _UserAvatar(index: 0),
                                    ),
                                    Positioned(
                                      left: 25,
                                      child: _UserAvatar(index: 1),
                                    ),
                                    Positioned(
                                      left: 50,
                                      child: _UserAvatar(index: 2),
                                    ),
                                  ],
                                ),
                              ),
                    ...
                    GridView.count(
                      ...
                      children: const [
                        CourseCard(
                          ...
                          description:
                              'বিসিএস প্রস্তুতি ১২০ দিন কোর্সটি ডিজাইন করা হয়েছে পুরাতন বা নতুন সবাইকে সবার জন্য...',
                          badge: '১২০ দিনের',
                        ...
                        CourseCard(
                          ...
                          description:
                              'বিগত বছরের শিক্ষক নিবন্ধন পরীক্ষার ব্যাখ্যা সহ সমাধান এবং পূর্ণাঙ্গ রুটিন মাফিক প্রস্তুতি।',
                          badge: '১১ তম',
                          bannerTopText: '১১ তম',
                        ...
                        CourseCard(
                          ...
                          description:
                              'প্রাথমিক শিক্ষক নিয়োগ পরীক্ষার বিগত সকল বছরের ব্যাখ্যা সহ প্রশ্নে সাজানো প্রাইমারি প্রশ্ন ব্যাংক কোর্স।',
                          bannerTopText: 'বিগত বছরের',
                          bannerTitle: 'প্রাইমারি প্রশ্ন ব্যাংক',
                          bannerSubtitle:
                              'সকল প্রশ্নের সাথে বিস্তারিত ব্যাখ্যা',
                        ),
                        CourseCard(
                          imagePath: 'assets/images/course_4.jpg',
                          title: '৫০ নম্বরের ডেইলি টেস্ট',
                          description:
                              '২০০ নম্বরের আনুপাতিক হারে ২০ মিনিটেই হবে পূর্ণাঙ্গ প্রস্তুতি নিশ্চিত করুন।',
                        ...
                        CourseCard(
                          ...
                          description:
                              'ব্যাখ্যাসহ সকল ব্যাংক জব সমাধান এবং বিগত বছরের প্রশ্নপত্রের বিস্তারিত বিশ্লেষণ।',
                        ...
                        CourseCard(
                          ...
                          description:
                              'কোর্সটি সাজানো হয়েছে যারা বছরব্যাপী শিক্ষক নিবন্ধন (NTRCA) এর প্রস্তুতি নিতে চাচ্ছে।',
                          bannerTopText: 'বিগত বছরের',
                    ...
                    GridView.count(
                      ...
                      children: const [
                        AppFeatureCard(
                          ...
                          description:
                              'হাজারো প্রতিযোগীর সাথে ঘরে বসেই লাইভ পরীক্ষা দিয়ে যাচাই করা যাবে নিজের প্রস্তুতি',
                        ),
                        AppFeatureCard(
                          icon: Icons.menu_book_rounded,
                          title: 'বিষয়ভিত্তিক মডেল টেস্ট',
                          description:
                              'বিষয়ভিত্তিক পার্সোনালাইসড আনলিমিটেড মডেল টেস্ট। নিজেই সেট করা যাবে পরীক্ষার সময় এবং নম্বর',
                        ),
                        AppFeatureCard(
                          icon: Icons.auto_stories_rounded,
                          title: 'অধ্যায়ভিত্তিক অনুশীলন',
                          description:
                              '৩০০+ টপিক সাব টপিকের উপর পড়াশোনা ও রিভিশনের সুযোগ',
                        ),
                        AppFeatureCard(
                          icon: Icons.contact_support_outlined,
                          title: 'ব্যাখ্যা সহ প্রিমিয়াম প্রশ্নব্যাংক',
                          description:
                              '১ লক্ষের অধিক ব্যাখ্যাসহ প্রিমিয়াম প্রশ্ন। প্রতিদিনেই যুক্ত হচ্ছে নতুন নতুন সব প্রশ্ন।',
                        ),
                        AppFeatureCard(
                          icon: Icons.assignment_outlined,
                          title: 'পূর্ণাঙ্গ প্রশ্নব্যাংক',
                          description:
                              'চাকরী পরীক্ষার পর দ্রুততম সময়ে ব্যাখ্যাসহ সমাধান আপলোড। বারবার জব সলিউশন কেনা থেকে মুক্তি',
                        ),
                        AppFeatureCard(
                          icon: Icons.alt_route_rounded,
                          title: 'কমপ্লিট বিসিএস গাইডলাইন',
                          description:
                              '৩৫ - ৪৫ বিসিএস প্রশ্ন এনালাইসি, সাবজেক্ট ভিত্তিক পূর্ণাঙ্গ গাইডলাইন',
                        ),
                      ],
                    ),
                  ],
                    ...
                    GridView.count(
                      ...
                      children: const [
                        GuidelineCard(
                          ...
                          description:
                              'বাংলা ভাষা ও সাহিত্যের হিটম্যাপ বিশ্লেষণ, ৩৬ জন গুরুত্বপূর্ণ সাহিত্যিক ও প্রস্তুতি কৌশল।',
                        ...
                        GuidelineCard(
                          ...
                          description:
                              'English Language & Literature-এর হিটম্যাপ, গুরুত্বপূর্ণ লেখক ও অধ্যয়ন কৌশল।',
                        ...
                        GuidelineCard(
                          ...
                          description:
                              'ইতিহাস, সংবিধান ও সাম্প্রতিক বাংলাদেশের সম্পূর্ণ টপিকভিত্তিক হিটম্যাপ।',
                          tags: [
                            'ইতিহাস',
                            'সংবিধান',
                            'মুক্তিযুদ্ধ',
